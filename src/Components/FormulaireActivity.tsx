...
import { activityCreate, Application, JobOffer, shopCreate } from "../interfaces";
...
const FormulaireActivity: React.FC<props> = (props) => {
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      ...
      const objectData:activityCreate = {
        name:values.name,
      ...
      try{
        postPutDeletRequest("/activitys",objectData,null,true,false,()=>{setLoadingCheck(false)},()=>{},myToken);
      } catch (error){};
    },
  });
...
export default FormulaireActivity;
